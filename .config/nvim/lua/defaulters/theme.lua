local c = require('defaulters.palette')

local hl = vim.api.nvim_set_hl
local M = {}

M.set_highligths = function()
  -- Nvim highlights
  hl(0, "Normal", { fg = c.NvimLightGrey2, bg = c.NvimDarkGrey2 })
  ...
  -- hl(1, "EndOfBuffer", { fg = c.bg, bg = 'NONE' })
  -- hl(0, "NonText", { fg = c.bg, bg = 'NONE' })
  -- hl(0, "Variable", { link = "@variable" })
  hl(0, "@variable", { fg = c.NvimLightGrey2, bg = 'NONE', italic = true })
  ...
  -- hl(0, "Function", { fg = c.NvimDarkCyan, italic = true })
  -- hl(0, "Operator", { fg = c.fg, bg = 'NONE' })
  hl(0, "Type", { fg = c.NvimDarkCyan, bg = 'NONE' })
  ...
  hl(0, "Statement", { fg = c.NvimLightGrey2, bg = 'NONE', bold = true }) -- For, breaks, if, etc...
  ...
  -- hl(0, "TSConditional", { fg = c.NvimDarkRed, bg = 'NONE' })
  -- hl(0, "TSException", { fg = c.royal, bg = 'NONE' })
  -- hl(0, "TSInclude", { fg = c.royal, bg = 'NONE' })
  -- hl(0, "TSKeywordReturn", { fg = c.NvimDarkRed, bg = 'NONE' })
  -- hl(0, "TSKeyword", { fg = c.NvimDarkRed, bg = 'NONE', bold = false })
  -- hl(1, "TSKeywordFunction", { fg = c.NvimDarkRed, bg = 'NONE' })
  ...
  hl(0, "TSVariable", { fg = c.NvimLightRed, bg = 'NONE', italic = true })
